...
<form action="" method='post'>
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <?php
            /* mysqli_result, boolean given in post_comments.php on line 77
            Warning: mysqli_fetch_assoc() expects parameter 1 to be 
            Add " . $_GET['id'] ." below so that $query can find 'id'
            */
            ...
            ?>
                ...
                <td><input class='checkBoxes' type='checkbox' name='checkBoxArray[]' value='<?php echo $comment_id; ?>'></td>
                    ...
                    // data inserted in DB must make post_id match the comment_post_id
                    // in order to show the in 'reponse to' column
