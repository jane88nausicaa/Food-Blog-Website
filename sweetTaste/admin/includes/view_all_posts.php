...
<table class="table table-bordered table-hover">
    <!-- sb-admin: #bulkOptionsContainer
    Solution: wrap columns in a row
    Reason: Bootstrap columns have a 15px padding one each side 
    while the Bootstrap row has 15px of negative margin on each.
    -->
    <div class="row">
...
<script>
    $(document).ready(function(){
       $(".delete_link").on('click', function(){
           ...
           var delete_rul = "posts.php?delete="+ id +" ";
           
           $(".modal_delete_link").attr("href", delete_rul);
